...
5. [Certificate Transfer Process](#certificate-transfer-process)
...
- [Maestro Cross-Account Architecture](./maestro-architecture-diagram.md) - IAM roles and cross-account trust details
- [Deploying Maestro](./deploying-maestro.md) - Step-by-step deployment guide
- [Manual Certificate Transfer Guide](./maestro-manual-cert-transfer.md) - Detailed certificate transfer procedures
- [Maestro End-to-End Testing](./testing-maestro-end-to-end.md) - Testing and validation procedures
