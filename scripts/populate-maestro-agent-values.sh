...
# Step 3: Detect AWS region
echo ""
echo "Step 3: Detecting AWS region from profile..."
...
echo ""
echo "Step 4: Creating values-override.yaml..."
...
echo -e "  ${GREEN}✓ values-override.yaml created successfully${NC}"
