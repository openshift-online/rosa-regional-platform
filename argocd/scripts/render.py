...
# To make changes:
# - For default changes: Edit values.yaml files in argocd/{cluster_type}/*/values.yaml
# - For region-specific changes: Edit argocd/config.yaml
...
def get_cluster_types(base_dir: Path) -> List[str]:
    ...
    for item in base_dir.iterdir():
        if item.is_dir() and not item.name.startswith('.') and item.name not in ['scripts', 'rendered']:
